...
public class EventReportActivity extends AppCompatActivity {
    ...
    //:adrian
    private ImageView mEditImageEventLocation;
    boolean flag = true;
    String stringLoc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //adrian:
        mEditImageEventLocation = (ImageView) findViewById(R.id.img_event_location);
        mEditImageEventLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (flag) {
                    ...
                    mEditTextLocation.setText(stringLoc);
                    flag = !flag;
                }
            }
        });
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected void onPostExecute(Void input) {
                if (mAddressList.size() >= 3) {
                    ...
                    stringLoc = mAddressList.get(0) + ", " + mAddressList.get(1) +
                            ", " + mAddressList.get(2) + ", " + mAddressList.get(3);
                }
            }
        }.execute();
